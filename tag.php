...
if ( have_posts() ) : ?>
	...
	<section>
		<header>
			<h2>Etiquetas: <?php printf( __( 'Etiqueta: "%s"', 'platzi' ), single_cat_title( '', false ) ); ?></h2>
		</header>
	...
	<?php else : ?>
		<article>
			<h2><?php _e('En esta etiqueta no hay nada publicado.', 'platzi');?></h2>
		</article>
	<?php endif; ?>
	</section>
